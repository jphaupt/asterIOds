...
# maybe make this random, or depend on the current rock size
...
#    print("Spawning rocks")
    num_to_spawn = int(score/20) + 1#random.randint(1,4) # how many rocks do I spawn? make function of score? make random?
